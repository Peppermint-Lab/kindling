...
- [`docs/control-plane-backup-and-dr.md`](https://github.com/kindlingvm/kindling/blob/main/docs/control-plane-backup-and-dr.md) — control-plane vs workload backup scope, recovery ordering.
- [Control-plane backup and DR](/operate/control-plane-backup-and-dr) — summary and links for operators.
- [Backup and restore](/operate/backup-and-restore) — procedures (Postgres / volumes / validation).
- [Operations runbook](/operate/operations-runbook) — install, upgrade, backup, drain, audit checklist index.
