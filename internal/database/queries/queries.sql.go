...
VALUES ($1, $2, $3)
RETURNING id, project_id, deployment_id, domain_name, verified_at, redirect_to, redirect_status_code, created_at, updated_at
`
...
func (q *Queries) DomainCreate(ctx context.Context, arg DomainCreateParams) (Domain, error) {
	row := q.db.QueryRow(ctx, domainCreate, arg.ID, arg.ProjectID, arg.DomainName)
	var i Domain
	err := row.Scan(
		&i.ID,
		&i.ProjectID,
...
SELECT id, project_id, deployment_id, domain_name, verified_at, redirect_to, redirect_status_code, created_at, updated_at
FROM domains
